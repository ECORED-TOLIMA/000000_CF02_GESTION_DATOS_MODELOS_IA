...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-12.col-md-10(data-aos="fade-down")
        ImagenInfografica.color-acento-botones.mb-4.desktop
          template(v-slot:imagen)
            figure
              img.mb-4(src='@/assets/curso/temas/tema4/img-04-v01.svg', alt='Imagen decorativa')
    ...
    p.mb-4 A partir de esta matriz se derivan todas las demás métricas de clasificación:
    ...
    p.mb-4 Para problemas de regresión, donde la variable objetivo es continua, se utilizan:
