...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4(data-aos="fade-left") A continuación, se detalla lo expresado por algunos autores:

    .row.align-items-center.m-0.mb-4.style___box_8(data-aos="zoom-in")
      .col-xl-auto
    ...
    p.mb-4(data-aos="fade-left") En esencia, la limpieza de datos es un proceso de aseguramiento de la calidad. Su objetivo es maximizar la consistencia, precisión, completitud y uniformidad de los datos para que representen fielmente la realidad que se pretende modelar. Se podría utilizar la siguiente analogía para explicar la limpieza de datos. 
